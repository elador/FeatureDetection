...
public:
	 ...
	 */
	explicit LearningWvmSvmModel(shared_ptr<FeatureExtractor> featureExtractor, shared_ptr<VDetectorVectorMachine> wvm,
	 ...
	 */
	explicit LearningWvmSvmModel(string configFilename, string negativesFilename);
