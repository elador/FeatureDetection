...
PositionDependentMeasurementModel2::PositionDependentMeasurementModel2(shared_ptr<FeatureExtractor> filterFeatureExtractor,
...
PositionDependentMeasurementModel2::~PositionDependentMeasurementModel2() {}

void PositionDependentMeasurementModel2::reset() {
	classifier->reset();
	usable = false;
}
...
vector<Mat> PositionDependentMeasurementModel2::getFeatureVectors(vector<Sample>& samples, function<bool(Mat&)> pred) {
