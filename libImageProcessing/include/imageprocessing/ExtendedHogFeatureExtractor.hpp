...
public:
	...
	ExtendedHogFeatureExtractor(std::shared_ptr<ImagePyramid> pyramid,
			std::shared_ptr<ExtendedHogFilter> ehogFilter, int cols, int rows);
	 ...
	 */
	ExtendedHogFeatureExtractor(std::shared_ptr<ExtendedHogFilter> ehogFilter,
...
private:
	...
	std::shared_ptr<ExtendedHogFilter> ehogFilter; ///< Extended HOG filter that is applied to the patches.
